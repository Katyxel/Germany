    ...
    <div className="py-10 container">
      ...
      <div>
        ...
        <ul className="mb-4">
          ...
          <li className="list-disc">
            По желанию клиента проводим полноценную платную консультацию с одним
            из наших специалистов в формате видеозвонка, если нет понимания
            процесса, остались дополнительные вопросы (по желанию клиента
            стоимость консультации можем вычесть из окончательной суммы)
          </li>
          <li className="list-disc">
        ...
        <ul className="mb-4">
          ...
          <li className="list-disc">
           Определяемся с итоговым перечнем
            программ, куда будем поступать (количество программ зависит от
            Тарифа)
          </li>
          <li className="list-disc">
          ...
          <li className="list-disc">
            Помогаем со сбором пакетов документов для каждого учебного заведения
            (бывает, что пакеты документов варьируются), ориентируем клиента по
            вопросам переводов, заверений, апостилей и т. д., то есть с любым
            вопросом в процессе работы мы готовы помочь
          </li>
          <li className="list-disc">
            Занимаемся корректировкой резюме и мотивационного письма для подачи
            на программы, кстати, в некоторых университетах мотивационное письмо
            является важнейшим фактором, который влияет на положительный ответ
            комиссии
          </li>
          <li className="list-disc">
