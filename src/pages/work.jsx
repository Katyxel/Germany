    ...
    <div className="container">
      <div className="bg-gray-800 text-white py-4 mt-6">
        <div className="container mx-auto mt-8">
          <h1 className="text-4xl font-bold text-center">РАБОТА В ГЕРМАНИИ</h1>
        </div>
      </div>

      <div className="bg-white w-full p-8">
        <p className="text-gray-800 text-xl text-center">
          Вы гарантированно в разы повысите шансы на получение оффера по работе
          в немецкой компании и проще пройдёте период интеграции и адаптации.
        </p>
      </div>
