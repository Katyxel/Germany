...
<Tabs isFitted variant="enclosed" colorScheme='red'>
  ...
  <TabPanels>
    <TabPanel>
      ...
      <ul className="mb-4">
        <li className="list-disc">Полный процесс поступления на 3 программы</li>
        ...
        <li className="list-disc">
          «3 авторских гайда: Основные шаги после зачисления», «Поиск жилья в
          Германии», «Полезное для студентов»
        </li>
      </ul>
    </TabPanel>
    <TabPanel>
      ...
      <ul className="mb-4">
        <li className="list-disc">Полный процесс поступления на 5 программ</li>
        ...
        <li className="list-disc">Оформление «въездной» страховки инкаминг</li>
    ...
    <TabPanel>
      ...
      <ul className="mb-4">
        ...
        <li className="list-disc">Сопровождение первого месяца в Германии</li>
      </ul>
    </TabPanel>
  </TabPanels>
</Tabs>
